	...
	process {
		foreach ($CA in $CertificationAuthority) {
			...
			if ($RequestID -ne $null) {
				$RequestID | ForEach-Object {Get-RequestRow -CA $CA -Property $Property -Table "Pending" -Filter "RequestID -eq $_" -Schema $Schema}
			} else {
				Get-RequestRow -CA $CA -Property $Property -Table "Pending" -Filter $Filter -Schema $Schema
			}
		}
	}
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCO0OhxDOK4UJhT
# PBRf4ZB1ZZKCuiJ1xbAEJhcK3JemNaCCEuQwggPuMIIDV6ADAgECAhB+k+v7fMZO
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJmMU/KtPSwW
# XG50+wy8ri9TUYLc7h7VoCPFB2wWqReUMA0GCSqGSIb3DQEBAQUABIIBANnVXPJv
# QVuZox7Q//Wz9SLOcmxqnZoln5IxcEp5UBaD6o3wu4u/0ba1InmHXi6jyXAakuX8
# tSMQnEeN5mijgx7aqZ9OXOikjSOfv2Lc5bz+jjgN3rOQHPk2TorEobrxeq65665V
# kGGDW+w+7oOsfmISB6xLwOPR9WrzCW7BtkN6+5LV4Fke6wAwuWbeE6+3dECeYo0M
# ePLEMO1XIltVqxmNCyUKsAVhorQtPfeqprtfSDEMp4b6n0S3Ikzifp4DgXZqq5Nm
# KZZFCht8DcPqaexg49PAAg9GRwyGXuwnsEiAff7JrUqlvszk7kZMBke20LwZ7AQX
# Kj0t3YYfi51Zdg+hggILMIICBwYJKoZIhvcNAQkGMYIB+DCCAfQCAQEwcjBeMQsw
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTYwODA3MTgwNDI2WjAjBgkqhkiG9w0BCQQx
# FgQUKxvlKKIetO19ycqtp3YG5aqbmHkwDQYJKoZIhvcNAQEBBQAEggEAToPci/4g
# iudse7OvCCzwnfnSYxKShoOJwkrbxCM/05UnBM1lJjT7xt6z+9ORBLpmhy5gigjh
# EZGHM50g7LxH63o26eFm91cCPl9wx7mUNtTpRMSMIfJccWzaUB5KrX+YqxUllVSX
# u5C+rOX472PwZo+o8CYo0p4FwObOS/v9V9cKMboKAMcynq/FNev1lN5D5umq5ZIb
# 9812cJIG3XSwCrwHVYXZnk5XHhDP5pGeieVeSyE7P1a5CY0Cv2rCHqseAt1Syvh+
# 8g2cPosN7PpPDMWnFsnZePcKqEVsGch8fHVBuIdF2EmTNJpveXA3zNb8UuHwh20o
# a020PKSQ8uRBXg==
