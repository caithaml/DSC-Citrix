	...
	process {
		foreach ($CA in $CertificationAuthority) {
			...
			if ($RequestID -ne $null) {
				$RequestID | ForEach-Object {Get-RequestRow -CA $CA -Property $Property -Table "Revoked" -Filter "RequestID -eq $_" -Schema $Schema}
			} else {
				Get-RequestRow -CA $CA -Property $Property -Table "Revoked" -Filter $Filter -Schema $Schema
			}
		}
	}
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB8Otve0wZ3hWtl
# XChCzbyRvefgsaGaw2a3nVg8Bgwdr6CCEuQwggPuMIIDV6ADAgECAhB+k+v7fMZO
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICblgtXjS8oJ
# dsURkWJBapknWnCblgJ8JSq9MCWiHOEcMA0GCSqGSIb3DQEBAQUABIIBAAYMSxpa
# neOyqHwaq7tk84JA9/FnT0WjEUH47ZCnBf18kMAj+Bgd3Lt4Vbj2ub19HwD81PAW
# ZLf8VgVUlgT5Sm1xzf36bByIzLCEtc8OjZV5Jk5g8Wp0fxtN/0IV/ibzP34w1ecB
# 2ZBVk09m+x4Vo8P+7pGAVVB+NtkEi2IofC8S1hbnmBq2llLjCFE+cV/EyarpnW8Q
# PtEs42prOAtO7ZXhEgv5foVqaToFZTDiY2875xM83QBvyxhvSheRI3d27luNTpav
# bMfS6ZwROTOMdxA+aYKneNjgv+0P9aB85HsjM5VmHtmqeUOfsKfrupNHswBxMtUW
# 6gNprgWlAdb3Aw6hggILMIICBwYJKoZIhvcNAQkGMYIB+DCCAfQCAQEwcjBeMQsw
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTYwODA3MTgwNDM1WjAjBgkqhkiG9w0BCQQx
# FgQUAPAPmT3u1QJCVM2fytRX/PUrFV0wDQYJKoZIhvcNAQEBBQAEggEAA6SqN3cX
# gEecOQAHiMts6ifNUMPuGamcAGQTCrc5cub/l/KISSZMfIv2oxl2tT7TKjK2vHb8
# 3ocJAnyviMD8qn12d9VYt57WwkEFcQ/8HbjKUZuNxgtiYOCxZ/Pd03RUaUu33uLm
# w8b6TfDQUfcfqcWqCTWl4S/st9hnDPcuNgH9C25YGdBOA03RSbvO4u2xR/QmjIgr
# Ay+dORxlfYYdxOX+rjLOtKPxXmZ/kWYBQXys+3I2SYHhOK+Uakls4u8X4HH7Pux/
# ZiDmc8s4CghCosMXY7G+wP82K9sEFB8bEAOIhwV3FNtuvaFVyy+rBqi8AjiLiiSN
# WlVC3Hdd+2Ne2w==
