			...
			foreach ($Entry in $Acl.Access) {
				switch -regex ($Entry.Permissions) {
					...
					"Read|Write" {
						...
						} elseif ($Entry.Permissions -contains "Read") {"GenericRead"}
						elseif ($Entry.Permissions -contains "Write") {"WriteProperty","WriteDacl","WriteOwner"}
						$ACE = New-Object DirectoryServices.ActiveDirectoryAccessRule (
							$Entry.IdentityReference,
							$Rights,
							$Entry.AccessType
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCd1INcR+ojYk2O
# H6wX4A5KZ37JaMPeQswf9wFVwzsIxKCCEuQwggPuMIIDV6ADAgECAhB+k+v7fMZO
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJQNCur99QLB
# Rt3zbLrx0IIpijGye0Rbi+wwj+s4G8yDMA0GCSqGSIb3DQEBAQUABIIBAGzDG6XN
# Dbe7zSI+IPLBOAfpVL3JYs0NJq1ZE3vBVGGKE7TyWizUaDKiCxt3MPempQyR7KdC
# K6YlFeIBkYZUlKLvYRLkJNTkAg5+KPlJ0o9KKVJag7rqRjw7TO0KDOzBxsAxN6f8
# 8kQGuM80EJ+noXUq84CN0PD27hy7xv8Lq8qmI0kPyJE9t9ris7TeujbdM7qFS57a
# ZSfUENgHDO4PjiSvcMPLScmExOWkYJEXaSV7ndD1frdGOE/MOiHknzNbJHKKOUXf
# Fu2dURi1LuS5V+LGICQiKa7csWgpG8o6/dzJp51oHTnNlJqikM/P8jykeJ6k62Ua
# XOozG9tObnopjVihggILMIICBwYJKoZIhvcNAQkGMYIB+DCCAfQCAQEwcjBeMQsw
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTYwODA3MTgwNTU5WjAjBgkqhkiG9w0BCQQx
# FgQULrOZi926Iy+t0MRIECbyRF8I0ekwDQYJKoZIhvcNAQEBBQAEggEAdh87U/+k
# ym09lYFzrH6IMAlWj1b5tQmHreqKvsPnr4aD1DN+FcHTEfykaW0hayZajTqlsQbG
# DwSMacqiCqmunAEqZsZ7MnAO2sAHVg1Q3qPZHug8NSUw1Xj647Df5M82WNiD5VBv
# PVoZ6G2Bv/Qfcn+BE1zDmwZBBChemkPP2t0qknC8y8nK4zN0qQjgFkrfQuowIgzW
# ng1sP/QZY+Q/UXpDTToKZrmi2OkU0C9bGr7aQDr/hUUFE9vM5/rVCgUI3NWhRPBT
# tkDhJBkOjWLbMMG+Q+kKaKVd+gNaMGwoHeYQo66rTbld1XnH/QMwTlLgkZz2bVqQ
# rczMn6JSnyuA+w==
